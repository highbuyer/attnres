...
SEARCH_TASKS = [
    ...
    ("当前 SFT 默认数据路径是在哪里定义的？", "search_code", {"query": "DATA_PATH ="}),
    ...
    ("评估脚本默认评估哪个 checkpoint？", "search_code", {"query": "--checkpoint"}),
    ("项目里 special tool token 是在哪里配置的？", "search_code", {"query": "<|tool_call_start|>"}),
...
READ_TASKS = [
    ...
    ("给我看 `src/sft.py` 里 special token IDs 那一段。", "read_file", {"path": "src/sft.py", "offset": 100, "limit": 14}),
    ...
    ("把 `src/tool_protocol.py` 里 `validate_tool_sample` 附近的代码给我看一下。", "read_file", {"path": "src/tool_protocol.py", "offset": 55, "limit": 28}),
]
