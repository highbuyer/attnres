...
BENCH = [
    ...
    # --- 基础常识 (15条) ---
    {"id": "ks_01", "category": "基础常识", "prompt": "中国的首都是哪里？"},
    {"id": "ks_02", "category": "基础常识", "prompt": "水的化学式是什么？"},
    {"id": "ks_03", "category": "基础常识", "prompt": "鲁迅的原名是什么？"},
    {"id": "ks_04", "category": "基础常识", "prompt": "地球绕太阳转一圈需要多久？"},
    {"id": "ks_05", "category": "基础常识", "prompt": "光速大约是多少？"},
    {"id": "ks_06", "category": "基础常识", "prompt": "《红楼梦》的作者是谁？"},
    {"id": "ks_07", "category": "基础常识", "prompt": "人类有多少条染色体？"},
    {"id": "ks_08", "category": "基础常识", "prompt": "金刚石的化学成分是什么？"},
    {"id": "ks_09", "category": "基础常识", "prompt": "太阳系有几颗行星？"},
    {"id": "ks_10", "category": "基础常识", "prompt": "二氧化碳的化学式是什么？"},
    {"id": "ks_11", "category": "基础常识", "prompt": "世界上最高的山峰是哪座？"},
    {"id": "ks_12", "category": "基础常识", "prompt": "1+1等于几？"},
    {"id": "ks_13", "category": "基础常识", "prompt": "圆周率 π 约等于多少？"},
    {"id": "ks_14", "category": "基础常识", "prompt": "《钢铁是怎样炼成的》作者是谁？"},
    {"id": "ks_15", "category": "基础常识", "prompt": "爱因斯坦提出了什么理论？"},
    ...
    {"id": "cd_04", "category": "代码逻辑", "prompt": "列表 [3,1,4,1,5,9] 排序后是什么？"},
